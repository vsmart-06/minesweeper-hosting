...
async def remove(mess: commands.Context):
    ...
    try:
        ...
        msg = msg.replace(">", "")
        user_id = int(msg)
        member = mess.guild.get_member(user_id)
        if not member:
